# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-11 12:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=datetime.datetime(2017, 4, 11, 12, 13, 53, 660390))),
            ],
            options={
                'db_table': 'auth_user',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sifra', models.CharField(max_length=5, unique=True)),
